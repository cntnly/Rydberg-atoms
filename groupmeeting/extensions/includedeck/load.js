...
function includedeck(m, c) {
    ...
    var info = {
        ...
        "jqmath": [
           prefix + "/extensions/jqmath/jqmath-0.4.0.css",
   //         prefix + "/extensions/jqmath/jquery-1.4.3.min.js",
            prefix + "/extensions/jqmath/jqmath-etc-0.4.2.min.js"
        ],
        "simplemath": [
        ...
        "profile-1": ["@_deck", "@_fit-fs", "@_jqmath", "@_simplemath", "@_clone", "@_goto", "@_status", "@_navigation", "@_menu", "@_step", "@_events", "@_anim", "@_svg"],
        "profile-1-fitnofs": ["@_deck", "@_smartsyntax", "@_fit", "@_jqmath", "@_simplemath", "@_clone", "@_goto", "@_status", "@_navigation", "@_menu", "@_step", "@_events", "@_anim", "@_svg"],
        /// profile-2: new deck (cleaner css) with most extensions and no theme
        "profile-2": ["@_newdeck", "@_ssmartsyntax", "@_fit-fs", "@_jqmath", "@_simplemath", "@_clone", "@_goto", "@_status", "@_navigation", "@_menu", "@_step", "@_events", "@_anim", "@_svg"],
        "profile-2-fitnofs": ["@_newdeck", "@_ssmartsyntax", "@_fit", "@_jqmath", "@_simplemath", "@_clone", "@_goto", "@_status", "@_navigation", "@_menu", "@_step", "@_events", "@_anim", "@_svg"],
        ...
        "profile-3": ["@_newdeck", "@_smartsyntax", "@_fit-fs", "@_simplemath", "@_clone", "@_goto", "@_progress", "@_navigation", "@_menu", "@_step", "@_events", "@_anim", "@_svg",
                      "@_metadata", "@_attribution","@_fit-fs", "@_container-styling", "@_timekeeper"],
        "profile-4": ["@_newdeck", "@_ssmartsyntax", "@_fit-fs", "@_clone", "@_goto", "@_progress", "@_navigation", "@_menu", "@_step", "@_events", "@_anim", "@_svg",
